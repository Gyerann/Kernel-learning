...
EFI_STATUS efi_main (EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable) {
	...
	if(
		...
		Print(L"Kernel header incorrect\n\r");
	...
	return EFI_SUCCESS; // Exit UEFI application
}
